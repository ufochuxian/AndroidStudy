...
public class MagicTextView extends AppCompatTextView {
	...
	public void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			String typefaceName = a.getString(R.styleable.MagicTextView_magicText_typeface);
			if (typefaceName != null) {
				Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("fonts/%s.ttf", typefaceName));
				setTypeface(tf);
			}

			if (a.hasValue(R.styleable.MagicTextView_magicText_foreground)) {
				Drawable foreground = a.getDrawable(R.styleable.MagicTextView_magicText_foreground);
				if (foreground != null) {
					this.setForegroundDrawable(foreground);
				} else {
					this.setTextColor(a.getColor(R.styleable.MagicTextView_magicText_foreground, 0xff000000));
				}
			}

			if (a.hasValue(R.styleable.MagicTextView_magicText_background)) {
				Drawable background = a.getDrawable(R.styleable.MagicTextView_magicText_background);
				if (background != null) {
					this.setBackgroundDrawable(background);
				} else {
					this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_magicText_background, 0xff000000));
				}
			}

			if (a.hasValue(R.styleable.MagicTextView_magicText_innerShadowColor)) {
				this.addInnerShadow(a.getFloat(R.styleable.MagicTextView_magicText_innerShadowRadius, 0),
						a.getFloat(R.styleable.MagicTextView_magicText_innerShadowDx, 0),
						a.getFloat(R.styleable.MagicTextView_magicText_innerShadowDy, 0),
						a.getColor(R.styleable.MagicTextView_magicText_innerShadowColor, 0xff000000));
			}

			if (a.hasValue(R.styleable.MagicTextView_magicText_outerShadowColor)) {
				this.addOuterShadow(a.getFloat(R.styleable.MagicTextView_magicText_outerShadowRadius, 0),
						a.getFloat(R.styleable.MagicTextView_magicText_outerShadowDx, 0),
						a.getFloat(R.styleable.MagicTextView_magicText_outerShadowDy, 0),
						a.getColor(R.styleable.MagicTextView_magicText_outerShadowColor, 0xff000000));
			}

			if (a.hasValue(R.styleable.MagicTextView_magicText_strokeColor)) {
				float strokeWidth = a.getFloat(R.styleable.MagicTextView_magicText_strokeWidth, 1);
				int strokeColor = a.getColor(R.styleable.MagicTextView_magicText_strokeColor, 0xff000000);
				float strokeMiter = a.getFloat(R.styleable.MagicTextView_magicText_strokeMiter, 10);
				Join strokeJoin = null;
				switch (a.getInt(R.styleable.MagicTextView_magicText_strokeJoinStyle, 0)) {
					case (0):
